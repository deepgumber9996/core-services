...
// old payment gateway fetch tech.
       ...
       // Gateway gateway = getGateway(transaction.getGateway());
        ...
        if ((transaction.getTenantId().equalsIgnoreCase("pb.testing") || transaction.getTenantId().equalsIgnoreCase("pb.amritsar"))&&  transaction.getBusinessService().equalsIgnoreCase("PT")) {
